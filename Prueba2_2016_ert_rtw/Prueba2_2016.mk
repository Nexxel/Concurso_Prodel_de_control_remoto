###########################################################################
## Makefile generated for Simulink model 'Prueba2_2016'. 
## 
## Makefile     : Prueba2_2016.mk
## Generated on : Fri Jun 08 17:44:50 2018
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Prueba2_2016
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Prueba2_2016_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Prueba2_2016
...
INCLUDES_BUILDINFO = -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/include -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Prueba2_2016_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/registry/../include -I$(EV3_LMSTYPES_DIR)/../ -I$(EV3_LMS2012_DIR)/../ -I$(EV3_BYTECODES_DIR)/../ -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src
...
DEFINES_ = -DMODEL=Prueba2_2016 -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DTID01EQ=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -D_RTT_LCD_=7
...
DEFINES_STANDARD = -DMODEL=Prueba2_2016 -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO
...
OBJS = Prueba2_2016.o Prueba2_2016_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o linuxinitialize.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_ev3_color_sensor.o driver_ev3_encoder.o driver_ev3_gyro_sensor.o driver_ev3_motor.o driver_ev3_ultrasonic_sensor.o
...
%.o : $(START_DIR)/Prueba2_2016_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Prueba2_2016_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
driver_ev3_gyro_sensor.o : C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/ev3/src/driver_ev3_gyro_sensor.c
	$(CC) $(CFLAGS) -o "$@" "$<"
